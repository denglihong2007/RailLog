        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RollingStock = table.Column<string>(type: "TEXT", nullable: true),
                    FromStation = table.Column<string>(type: "TEXT", nullable: false),
                    ToStation = table.Column<string>(type: "TEXT", nullable: false),
                    DepartureTime = table.Column<TimeOnly>(type: "TEXT", nullable: true),
                    ArrivalTime = table.Column<TimeOnly>(type: "TEXT", nullable: true),
                    MileageKm = table.Column<decimal>(type: "decimal(8, 1)", nullable: false),
                    ViaRoutes = table.Column<string>(type: "TEXT", nullable: false),
