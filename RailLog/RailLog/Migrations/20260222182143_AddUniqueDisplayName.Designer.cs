...
namespace RailLog.Migrations
{
    ...
    [Migration("20260222182143_AddUniqueDisplayName")]
    partial class AddUniqueDisplayName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RailLog.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RailLog.Data.TripRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("ViaRouteSegments")
                        .IsRequired()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RailLog.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RailLog.Data.TripRecord", b =>
                {
                    b.HasOne("RailLog.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
